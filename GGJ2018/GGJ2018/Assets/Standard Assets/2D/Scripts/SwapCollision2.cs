...
public class SwapCollision2 : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        //    player1.transform.positon = temp;
        ...
        if (collision.gameObject.tag == "player1")
        {
            print("Swap player2 and player1 positions");
            Vector3 temp = player1.transform.position;
            player1.transform.position = player2.transform.position;
            player2.transform.position = temp;
            Destroy(gameObject);
        ...
        {
            print("Swap player2 and player3 positions");
        ...
        {
            print("Swap player2 and player4 positions");
            Vector3 temp = player4.transform.position;
            player4.transform.position = player2.transform.position;
            player2.transform.position = temp;
            Destroy(gameObject);
        }
    }
